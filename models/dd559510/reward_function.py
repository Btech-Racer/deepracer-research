...
def reward_function(params):
    ...
    # Initialize reward with base safe navigation value
    reward = 2.0

    # Enhanced object avoidance with predictive behavior
    ...
    if closest_object_distance < 1.2:
        ...
        if speed <= 1.0:
            ...
            speed_reward = -0.3  # enalty for going too quickly near objects
    else:
