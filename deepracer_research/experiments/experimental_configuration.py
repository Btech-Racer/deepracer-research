...
class ExperimentalConfiguration:
    ...
    racing_track: str = "reinvent_base"
    reward_function_name: str = "centerline_following"
    ...
    def _get_track_for_scenario(self) -> str:
        ...
        track_mapping = {
            ExperimentalScenario.CENTERLINE_FOLLOWING: "reinvent_base",
            ExperimentalScenario.STATIC_OBJECT_AVOIDANCE: "oval_track",
            ExperimentalScenario.DYNAMIC_OBJECT_AVOIDANCE: "bowtie_track",
            ExperimentalScenario.MULTI_AGENT_RACING: "head_to_head_track",
            ExperimentalScenario.SPEED_OPTIMIZATION: "speed_track",
            ExperimentalScenario.TIME_TRIAL: "time_trial_track",
            ExperimentalScenario.HEAD_TO_HEAD: "head_to_head_track",
        }
        return track_mapping.get(self.scenario, self.racing_track)
